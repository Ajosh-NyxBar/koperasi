                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: const Center(child: Icon(Icons.account_balance, size: 45, color: AppTheme.primaryColor)),
                    ),
                    ...
                    const SizedBox(height: 24),
                    Text('© 2024 KBMT - Semua Hak Dilindungi', style: GoogleFonts.poppins(fontSize: 11, color: Colors.white54)),
                  ],
                ),
              ),
            ),

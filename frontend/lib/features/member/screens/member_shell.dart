...
class MemberShell extends StatelessWidget {
  ...
  int _index(BuildContext context) {
    ...
    if (loc.startsWith('/member/savings')) return 1;
    if (loc.startsWith('/member/financings')) return 2;
    if (loc.startsWith('/member/profile')) return 3;
    return 0;
  }
      ...
      bottomNavigationBar: NavigationBar(
        ...
        onDestinationSelected: (i) {
          switch (i) {
            ...
            case 1: context.go('/member/savings');
            case 2: context.go('/member/financings');
            case 3: context.go('/member/profile');
          }
        },
